...
const CashFlow = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://192.168.68.228:3001/cashflow', formData, {
                headers: {
            ...
            if (response.status === 201) {
                navigate(`/comaker?loanId=${loanId}`); 
            ...
            <div className="sulodPormcas">
                ...
                <form className="cashflow" onSubmit={handleSubmit}>
                    ...
                    <div className="form-row-5">
                            ...
                            <button type="submit" class="submit-btn-1">Next</button>
                </form>
                <br></br>
